...
const jackieB = {
  ...
  actors: ['Samuel L Jackson', 'Pam Grier', 'Robert Deniro', 'Chris Tucker'],
  releaseYear: 1997,
  duration: 154,
};
let title = jackieB.title;
let director = jackieB.director;
let actors = jackieB.actors;
let releaseYear = jackieB.releaseYear;
let duration = jackieB.duration;
